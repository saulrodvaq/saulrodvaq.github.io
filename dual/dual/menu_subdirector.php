...
if (!esSubdirector($_SESSION['usuario'])) {
...
function esSubdirector($usuario) {
    ...
    $query = "SELECT * FROM subdirectores WHERE usuario = '$usuario'";
    $resultado = mysqli_query($conn, $query);
    $esSubdirector = mysqli_num_rows($resultado) > 0;
    mysqli_close($conn);
...
$sql = "SELECT *, idSubdirector FROM subdirectores WHERE usuario = '$usuario'";
...
$_SESSION['idSubdirector'] = $usuario['idSubdirector'];
...
<body>
    ...
    <header id="header" class="fixed-top2 header-inner-pages">
        <div class="container d-flex align-items-center justify-content-between">
            <h1 class="logo"><a href="/dual/index.php"><img src="assets/img/log-bar2.png" alt=""> </a></h1>
    ...
    <section id="cta" class="cta">
        <div class="container">
            <div class="text-center">
                ...
                <br>
                <h3 id="textoBanner" style="font-size: 68px"><?php echo 'Bienvenido, ' . $_SESSION['nombres'];?></h3>
                <h2>Subdirectivo</h2>
                <br>
            </div>
        </div>
                                ...
                                <table class="table table-responsive-sm text-center table-hover" id="tabla_id">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="fijo-column">Instructor</th>
                                            <th>Semana</th>
...
$query = "SELECT r.*, t.nombres as nombrestutor, t.apellidos as apellidostutor, i.nombres as nombresinstructor, i.apellidos as apellidosinstructor
            ...
            INNER JOIN subdirectores d ON r.carrera = d.carrera
            WHERE r.estatus_tutor = 'sin_revisar' AND r.estatus_instructor = 'sin_revisar' AND r.carrera = d.carrera
            ORDER BY r.idReporte DESC";
               ...
               INNER JOIN instructores i ON r.idInstructor = i.idInstructor
               INNER JOIN subdirectores d ON r.carrera = d.carrera
               WHERE (r.estatus_tutor = 'no_aprobado' OR r.estatus_instructor = 'no_aprobado')
               OR (r.estatus_instructor = 'aprobado' AND r.estatus_tutor = 'sin_revisar' AND r.carrera = d.carrera)
               OR (r.estatus_instructor = 'sin_revisar' AND r.estatus_tutor = 'aprobado' AND r.carrera = d.carrera)
               ORDER BY r.idReporte DESC";
               $respuesta = mysqli_query($conn, $query);
                ...
                INNER JOIN instructores i ON r.idInstructor = i.idInstructor
                INNER JOIN subdirectores d ON r.carrera = d.carrera
                WHERE r.estatus_tutor = 'aprobado' AND r.estatus_instructor = 'aprobado' AND r.carrera = d.carrera
                ORDER BY r.idReporte DESC";
                $respuesta = mysqli_query($conn, $query);
                ...
                ?>
                                        ...
                                        function showFeedback(element) {
                                            ...
                                            var retroInstructor = element.getAttribute('data-retro-instructor');
        ...
        Swal.fire({
            ...
            inputValidator: (value) => {
                Swal.fire({
                        ...
                        cancelButtonText: 'Cancelar',
                        preConfirm: (text) => {
                            return fetch("gestion/guardar_retroalimentacion.php", {
                                    method: "POST",
                                    body: JSON.stringify({
                                        id: id,
                                        retro: text,
