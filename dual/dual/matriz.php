    ...
    <header id="header" class="fixed-top2 header-inner-pages">
        <div class="container d-flex align-items-center justify-content-between">
            ...
            <nav id="navbar" class="navbar">
                <ul>
                    <li><a class="nav-link efectoboton scrollto" href="menu_formador.php">Regresar</a></li>
                </ul>
...
foreach ($asignaturasCompetencias as $ac) {
    ...
    const porcentajeCumplimiento = (asignaturasCumplidas.size / asignaturasTotales) * 100 * <?php echo $cantidadPuestos; ?>; // Calcular el porcentaje de cumplimiento
