...
if (!esDirector($_SESSION['usuario'])) {
...
function esDirector($usuario) {
    ...
    $query = "SELECT * FROM directores WHERE usuario = '$usuario'";
    $resultado = mysqli_query($conn, $query);
    $esDirector = mysqli_num_rows($resultado) > 0;
    mysqli_close($conn);
    return $esDirector;
}
...
$sql = "SELECT *, idDirector FROM directores WHERE usuario = '$usuario'";
...
$_SESSION['idDirector'] = $usuario['idDirector'];
