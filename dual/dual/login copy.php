                                    ...
                                    <div class="card-body p-md-5">
                                        <div class="row justify-content-center">
                                            <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                                                ...
                                                <h2 class="text-center h1 fw-bold mb-5 mx-1 mx-md-4 mt-4">Iniciar Sesión
                                                </h2>
                                                ...
                                                <form id="login-form" class="mx-1 mx-md-4">
                                                    <div class="d-flex flex-row align-items-center mb-4 green-bg">
                                                        ...
                                                        <div class="form-outline flex-fill mb-0">
                                                            <label class="form-label" for="form3Example1c"> <i
                                                                    class="fas fa-user fa-lg me-1 fa-fw"></i>Usuario</label>
                                                            <input type="text" name="usuario" id="form3Example1c"
                                                    ...
                                                    <div class="d-flex flex-row align-items-center mb-4 green-bg">
                                                        ...
                                                        <div class="form-outline flex-fill mb-0 position-relative">
                                                            ...
                                                            <input type="password" name="password" id="form3Example3c"
                                                                class="form-control shadow" />
                                                    ...
                                                    <div class="d-flex justify-content-center mx-4 mb-3 mb-lg-4">
                                                        <button type="submit" class="btn efectoboton shadow">Iniciar
                                                            Sesión</button>
                                                    </div>
                                                </form>
                                            </div>
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.success) {
                        ...
                        switch (userType) {
                            case "alumnos":
                                window.location.href = "menu_alumnos.php";
                                break;
                            case "directores":
                                window.location.href = "menu_direccion.php";
                                break;
                            case "subdirectores":
                                window.location.href = "menu_subdirector.php";
                                break;
                            case "formadores":
                                window.location.href = "menu_formador.php";
                                break;
                            case "administradores":
                                window.location.href = "menu_admin.php";
                                break;
                            case "tutores":
                                window.location.href = "menu_tutor.php";
                                break;
                            case "instructores":
                                window.location.href = "menu_instructor.php";
                                break;
                            case "docentes":
                                window.location.href = "menu_docente.php";
                                break;
                            default:
                                break;
                        }
