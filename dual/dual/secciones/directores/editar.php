...
if(isset($_GET["idDirector"])) {
    // Obtener el valor del campo idDirector de la URL
    $idDirector = $_GET["idDirector"];

    // Consulta para obtener los datos del Director correspondiente
    $query = "SELECT * FROM directores WHERE idDirector = $idDirector";
...
<body>
    <header id="header" class="fixed-top2 header-inner-pages">
        <div class="container d-flex align-items-center justify-content-between">
            ...
            <nav id="navbar" class="navbar">
                <ul>
                    <li><a class="scrollto efectoboton" href="directores.php">Regresar</a></li>
                </ul>
    ...
    <!-- Formulario para editar los datos del director -->
    <div class="container">
        <br />
        <br />
