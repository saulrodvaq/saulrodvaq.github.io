...
<head>
    ...
    <link rel="stylesheet" href="../../gestion/bootstrap/css2/bootstrap.min.css">
...
<body>
    <header id="header" class="fixed-top2 header-inner-pages">
        <div class="container d-flex align-items-center justify-content-between">
            ...
            <nav id="navbar" class="navbar">
                <ul>
                    <li><a class="scrollto efectoboton" href="periodos_concluidos.php">Regresar</a></li>
                </ul>
    ...
    <div class="container">
        <br />
        <br />
        <h1 class="mb-4 text-center" style="font-size: 68px; font-weight:800;">Historial de instructores</h1>
        <hr>
...
$query = "SELECT historial_instructores.*, instructores.nombres AS nombres_instructor, instructores.apellidos AS apellidos_instructor, instructores.matricula AS matricula_instructor
          FROM historial_instructores
          LEFT JOIN instructores ON historial_instructores.idInstructor = instructores.idInstructor
          WHERE historial_instructores.idAlumno = $idAlumno
          ORDER BY historial_instructores.fecha_asignacion DESC";
...
if (mysqli_num_rows($respuesta) > 0) {
    while($registro = mysqli_fetch_array($respuesta)) {
        echo "<tr>";
        echo "<td>$registro[idInstructor]</td>";
        echo "<td>$registro[nombres_instructor]</td>";
        echo "<td>$registro[apellidos_instructor]</td>";
        echo "<td>$registro[matricula_instructor]</td>";
        echo "<td>$registro[fecha_asignacion]</td>";
        echo "</tr>";
    }
}
...
?>
        ...
        <?php include("../../templates/footer_secciones.php");
                                ?>
        <!-- jQuery -->
