...
<body>
    ...
    <div class="container">
        <br />
        <br />
        <h1 class="mb-4 text-center" style="font-size: 68px; font-weight:800;">Historial de docentes</h1>
        <hr>
...
$query = "SELECT historial_docentes.*, docentes.nombres AS nombres_docente, docentes.apellidos AS apellidos_docente, docentes.matricula AS matricula_docente
          FROM historial_docentes
          LEFT JOIN docentes ON historial_docentes.idDocente = docentes.idDocente
          WHERE historial_docentes.idAlumno = $idAlumno
          ORDER BY historial_docentes.fecha_asignacion DESC";
...
if (mysqli_num_rows($respuesta) > 0) {
    while($registro = mysqli_fetch_array($respuesta)) {
        echo "<tr>";
        echo "<td>$registro[idDocente]</td>";
        echo "<td>$registro[nombres_docente]</td>";
        echo "<td>$registro[apellidos_docente]</td>";
        echo "<td>$registro[matricula_docente]</td>";
