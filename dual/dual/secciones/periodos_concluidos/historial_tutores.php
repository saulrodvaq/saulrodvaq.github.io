...
<body>
    ...
    <div class="container">
        <br />
        <br />
        <h1 class="mb-4 text-center" style="font-size: 68px; font-weight:800;">Historial de tutores</h1>
        <hr>
...
$query = "SELECT historial_tutores.*, tutores.nombres AS nombres_tutor, tutores.apellidos AS apellidos_tutor, tutores.matricula AS matricula_tutor
          FROM historial_tutores
          LEFT JOIN tutores ON historial_tutores.idTutor = tutores.idTutor
          WHERE historial_tutores.idAlumno = $idAlumno
          ORDER BY historial_tutores.fecha_asignacion DESC";
...
if (mysqli_num_rows($respuesta) > 0) {
    ...
    while($registro = mysqli_fetch_array($respuesta)) {
        ...
        echo "<td>$registro[nombres_tutor]</td>";
        echo "<td>$registro[apellidos_tutor]</td>";
        echo "<td>$registro[matricula_tutor]</td>";
