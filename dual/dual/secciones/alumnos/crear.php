...
<body>
    ...
    <div class="container">
        <br />
        <br />
        <h1 class="mb-4 text-center" style="font-size: 68px; font-weight:800;">Registro de alumnos</h1>
        <hr>
  ...
  ?>
                    ...
                    <select class="form-select mb-3" name="cuatrimestre" id="country">
                        <option>...</option>
                        <option>1</option>
                        <option>2</option>
                        <option>3</option>
                    ...
                    <label>Ingreso:</label>
                    <input type="date" class="form-control mb-3" name="ingreso" value="<?php echo date('Y-m-d'); ?>">

                    <label for="name">Duración</label>
                    <select class="form-select mb-3" name="duracion" id="country">
                        <option>...</option>
                        <option>1 Cuatrimestres</option>
                        <option>2 Cuatrimestres</option>
                        <option>3 Cuatrimestres</option>
                        <option>4 Cuatrimestres</option>
                        <option>5 Cuatrimestres</option>
                        <option>6 Cuatrimestres</option>
                        <option>7 Cuatrimestres</option>
                        <option>8 Cuatrimestres</option>
                        <option>9 Cuatrimestres</option>
                        <option>10 Cuatrimestres</option>
                        <option>11 Cuatrimestres</option>
                    </select>

                    <label>Fecha Fin:</label>
                    <input type="date" class="form-control mb-3" name="fecha_fin" value="<?php echo date('Y-m-d'); ?>">
                    ...
                    <div class="d-flex justify-content-center">
                        <a href="alumnos.php" class="btn btn-danger mx-1" boton class="boton boton1">Cancelar</a>
