...
if(isset($_GET["idDocente"])) {
    // Obtener el valor del campo idDocente de la URL
    $idDocente = $_GET["idDocente"];

    // Consulta para obtener los datos del Docente correspondiente
...
<body>
    ...
    <!-- Formulario para editar los datos del docente -->
    <div class="container">
        <br />
        <br />
        ...
        <form action="actualizar.php" method="POST">
            <div class="row">
                <div class="col-md-6 offset-md-3">
                    <input type="hidden" class="form-control mb-3" name="idDocente"
                        value="<?php echo $docente['idDocente']; ?>">
                    <label for="nombres">Nombre(s):</label>
                    <input type="text" class="form-control mb-3" name="nombres"
                        value="<?php echo $docente['nombres']; ?>">
                    ...
                    <input type="text" class="form-control mb-3" name="matricula"
                        value="<?php echo $docente['matricula']; ?>">
                    ...
                    <input type="text" class="form-control mb-3" name="password"
                        value="<?php echo $docente['password']; ?>">
                    <div class="d-flex justify-content-center">
                        <a href="docentes.php" class="btn btn-danger mx-1" boton class="boton boton1">Cancelar</a>
