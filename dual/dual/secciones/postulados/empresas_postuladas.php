...
<body>
    ...
    <main class="container mt-4" style="max-width: 1600px;">
        <br>
        <h1 class="mb-4 text-center" style="font-size: 68px; font-weight:800;">Empresas postuladas</h1>
        <br>
        <br>
        <div class="card">
            <div class="card-body">
                ...
                <div class="table-responsive text-center table-hover">
                    <table class="table table-responsive-sm text-center table-hover" id="tabla_id">
                        ...
                        <tbody>
                            <?php
            include("../../templates/conexion.php");
            $query = "SELECT * FROM empresas_postuladas ORDER BY idEmpresaPostulada DESC";
            $respuesta = mysqli_query($conn, $query);

            while ($registro = mysqli_fetch_array($respuesta)) {
                echo "<tr>";
                echo "<td>{$registro['idEmpresaPostulada']}</td>";
                ...
                echo("<td>
                        <div class='btn-group'>
                            <a class='btn btn-primary btn-sm altaBoton' href='registrar_empresa.php?idEmpresaPostulada=$registro[idEmpresaPostulada]' onclick='deshabilitarBoton(this)'>Registrar</a>
                        </div>
                </td>");
                echo "</tr>";
            }
