...
<body>
    ...
    <main class="container mt-4" style="max-width: 1600px;">
        <br>
        <h1 class="mb-4 text-center" style="font-size: 68px; font-weight:800;">Alumnos postulados</h1>
        <br>
        <br>
        <div class="card">
            <div class="card-body">
        ...
        ?>
            ...
            $query = "SELECT * FROM alumnos_postulados ORDER BY idPostulado DESC";
            $respuesta = mysqli_query($conn, $query);

            while($registro = mysqli_fetch_array($respuesta)) {
                echo("<tr>");
                    echo("<td>$registro[idPostulado]</td>");
                    ...
                    echo("<td>
                        <div class='btn-group'>
                            <a class='btn btn-primary btn-sm altaBoton' href='registrar_alumno.php?idPostulado=$registro[idPostulado]' onclick='deshabilitarBoton(this)'>Registrar</a>
                        </div>
                    </td>");
                echo("</tr>");
                }
