...
<body>
    <header>
        <header id="header" class="fixed-top2 header-inner-pages">
            <div class="container d-flex align-items-center justify-content-between">
                <a href="/dual/index.phpp" class="logo"><img src="../../assets/img/log-bar2.png" alt="" class="img-fluid"></a>
                <!-- Uncomment below if you prefer to use an image logo -->
                <!-- <a href="index.html" class="logo"><img src="assets/img/logo.png" alt="" class="img-fluid"></a>-->

                <nav id="navbar" class="navbar">
                    <ul>
                        <li><a class="scrollto efectoboton" href="crear.php">Agregar administrador</a></li>
    ...
    <br>
        <h1 class="mb-4 text-center" style="font-size: 68px; font-weight:800;">Administradores Dual</h1>
        <br>
        <br>
        <div class="card">
            <div class="card-body">
    ...
    ?>
        ...
        $query = "SELECT * FROM administradores ORDER BY apellidos";
        $respuesta = mysqli_query($conn, $query);

        while($registro = mysqli_fetch_array($respuesta)) {
            echo("<tr>");
            echo("<td>$registro[idAdministrador]</td>");
            ...
            echo("<td>
                <div class='btn-group'>
                    <a class='btn btn-primary btn-sm mr-1' href='editar.php?idAdministrador=$registro[idAdministrador]'>Editar</a>
                    |
                    <a class='btn btn-danger btn-sm mr-1' href='borrar.php?idAdministrador=$registro[idAdministrador]'>Eliminar</a>
                </div>
            </td>");
            echo("</tr>");
        }
