...
if(isset($_GET["idAdministrador"])) {
    // Obtener el valor del campo idAdministrador de la URL
    $idAdministrador = $_GET["idAdministrador"];

    // Consulta para obtener los datos del Administrador correspondiente
    ...
    <header id="header" class="fixed-top2 header-inner-pages">
        <div class="container d-flex align-items-center justify-content-between">
            ...
            <nav id="navbar" class="navbar">
                <ul>
                    <li><a class="scrollto efectoboton" href="administradores.php">Regresar</a></li>
                </ul>
        ...
        <form action="actualizar.php" method="POST">
            <div class="row">
                <div class="col-md-6 offset-md-3">
                    <input type="hidden" class="form-control mb-3" name="idAdministrador"
                        value="<?php echo $administrador['idAdministrador']; ?>">
                    <label for="nombres">Nombre(s):</label>
                    <input type="text" class="form-control mb-3" name="nombres"
                        value="<?php echo $administrador['nombres']; ?>">
                    <label for="apellidos">Apellidos:</label>
                    <input type="text" class="form-control mb-3" name="apellidos"
                        value="<?php echo $administrador['apellidos']; ?>">
                    <label for="matricula">Matrícula:</label>
                    <input type="text" class="form-control mb-3" name="matricula"
                        value="<?php echo $administrador['matricula']; ?>">
                    <label for="usuario">Usuario:</label>
                    <input type="text" class="form-control mb-3" name="usuario"
                        value="<?php echo $administrador['usuario']; ?>">
                    <label for="password">Password:</label>
                    <input type="text" class="form-control mb-3" name="password"
                        value="<?php echo $administrador['password']; ?>">
                    <div class="d-flex justify-content-center">
                        <a href="administradores.php" class="btn btn-danger mx-1" boton class="boton boton1">Cancelar</a>
