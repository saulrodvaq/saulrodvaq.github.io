...
<body>
        ...
        <header id="header" class="fixed-top2 header-inner-pages">
            <div class="container d-flex align-items-center justify-content-between">
                ...
                <nav id="navbar" class="navbar">
                    <ul>
                        <li><a class="scrollto efectoboton" href="crear.php">Agregar Formador</a></li>
    ...
    <main class="container mt-4" style="max-width: 1600px;">
        <br>
        <h1 class="mb-4 text-center" style="font-size: 68px; font-weight:800;">Formadores Dual</h1>
        <br>
        <br>
        <div class="card">
            <div class="card-body">
    ...
    ?>
        ...
        $query = "SELECT formadores.*, empresas.nombreEmp AS nombre_empresa FROM formadores INNER JOIN empresas ON formadores.idEmpresa = empresas.idEmpresa ORDER BY formadores.idFormador";
                                    $respuesta = mysqli_query($conn, $query);

        while($registro = mysqli_fetch_array($respuesta)) {
            echo("<tr>");
            echo("<td>$registro[idFormador]</td>");
            ...
            echo("<td>
                <div class='btn-group'>
                    <a class='btn btn-primary btn-sm mr-1' href='editar.php?idFormador=$registro[idFormador]'>Editar</a>
                    |
                    <a class='btn btn-danger btn-sm' href='borrar.php?idFormador=$registro[idFormador]'>Eliminar</a>
                </div>
            </td>");
            echo("</tr>");
        }
