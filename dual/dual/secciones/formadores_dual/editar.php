...
if(isset($_GET["idFormador"])) {
    // Obtener el valor del campo idFormador de la URL
    $idFormador = $_GET["idFormador"];

    // Consulta para obtener los datos del formador correspondiente
    $query = "SELECT * FROM formadores WHERE idFormador = $idFormador";
    $resultado = mysqli_query($conn, $query);
    $formador = mysqli_fetch_assoc($resultado);
}
...
<body>
    <header id="header" class="fixed-top2 header-inner-pages">
        <div class="container d-flex align-items-center justify-content-between">
            ...
            <nav id="navbar" class="navbar">
                <ul>
                    <li><a class="scrollto efectoboton" href="formadores_dual.php">Regresar</a></li>
                </ul>
    ...
    <!-- Formulario para editar los datos del formador -->
    <div class="container">
        <br />
        <br />
        ...
        <form action="actualizar.php" method="POST">
            <div class="row">
                <div class="col-md-6 offset-md-3">
                    <input type="hidden" class="form-control mb-3" name="idFormador"
                        value="<?php echo $formador['idFormador']; ?>">
                    <label for="nombres">Nombre(s):</label>
                    <input type="text" class="form-control mb-3" name="nombres"
                        value="<?php echo $formador['nombres']; ?>">
                    <label for="apellidos">Apellidos:</label>
                    <input type="text" class="form-control mb-3" name="apellidos"
                        value="<?php echo $formador['apellidos']; ?>">
                    <label for="matricula">Matrícula:</label>
                    <input type="text" class="form-control mb-3" name="matricula"
                        value="<?php echo $formador['matricula']; ?>">
                    <label>Empresa:</label>
  ...
  // Obtener el ID de la empresa del formador actual
  $queryFormadorEmpresa = "SELECT idEmpresa FROM formadores WHERE idFormador = $idFormador";
  $respuestaFormadorEmpresa = mysqli_query($conn, $queryFormadorEmpresa);
  $filaFormadorEmpresa = mysqli_fetch_assoc($respuestaFormadorEmpresa);
  $idEmpresaFormador = $filaFormadorEmpresa['idEmpresa'];
  ...
  while ($empresa = mysqli_fetch_array($respuestaEmpresas)) {
    ...
    $selected = ($idEmpresa == $idEmpresaFormador) ? 'selected' : '';
  ...
  ?>
                    ...
                    <input type="text" class="form-control mb-3" name="usuario"
                        value="<?php echo $formador['usuario']; ?>">
                    <label for="password">Password:</label>
                    <input type="text" class="form-control mb-3" name="password"
                        value="<?php echo $formador['password']; ?>">
                    <div class="d-flex justify-content-center">
                        <a href="formadores_dual.php" class="btn btn-danger mx-1" boton class="boton boton1">Cancelar</a>
