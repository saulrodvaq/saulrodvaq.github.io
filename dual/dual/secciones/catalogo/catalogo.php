...
include("../../templates/conexion.php");
  ...
  $sql = "SELECT idCarrera, nombre FROM carreras";
...
<body>
    <header id="header" class="fixed-top2 header-inner-pages">
        <div class="container d-flex align-items-center justify-content-between">
            ...
            <nav id="navbar" class="navbar">
                <ul>
                    <li><a class="nav-link efectoboton scrollto" href="agregar_carrera.php">Agregar carrera</a>
                    </li>
                    <li><a class="nav-link efectoboton scrollto" href="../../menu_admin.php">Regresar</a>
                    </li>
                </ul>
    ...
    <main class="container mt-4" style="max-width: 1600px;">
        <div class="container">
            ...
            <h1 class="mb-4 text-center" style="font-size: 68px; font-weight:800;">Catálogo de carreras</h1>
            <p class="text-center" style="font-size: 24px;">Bienvenido(a) al catálogo de carreras, podrá visualizar las
                carreras y materias vinculadas a cada una dependiendo su cuatrimestre, podrá editar y agregar nuevas
                carreras.</p>
            </br>
        </div>
        <div class="card">
                                ...
                                <td>
                                    <div class='btn-group'>
                                        <a class='btn btn-primary btn-sm mr-1'
                                            href="ver_asignaturas.php?idCarrera=<?php echo $fila['idCarrera']; ?>">Asignaturas</a>
                                        |
                                        <a class='btn btn-danger btn-sm mr-1'
                                            href="borrar_carrera.php?idCarrera=<?php echo $fila['idCarrera'];?>"
