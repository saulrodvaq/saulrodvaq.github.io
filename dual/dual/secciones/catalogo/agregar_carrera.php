...
<body>
    <header id="header" class="fixed-top2 header-inner-pages">
        <div class="container d-flex align-items-center justify-content-between">
            ...
            <nav id="navbar" class="navbar">
                <ul>
                    <li><a class="scrollto efectoboton" href="catalogo.php">Regresar</a></li>
                </ul>
    ...
    <div class="container">
        <br />
        <br />
        <h1 class="mb-4 text-center" style="font-size: 68px; font-weight:800;">Agregar carrera</h1>
        <hr>
        <form method="post" action="mensaje_carreras.php">
            <div class="row">
                <div class="col-md-6 offset-md-3">
                    ...
                    <div class="d-flex justify-content-center">
                        <a href="catalogo.php" class="btn btn-danger mx-1" boton class="boton boton1">Cancelar</a>
