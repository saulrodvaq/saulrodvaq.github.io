...
<body>
    <header id="header" class="fixed-top2 header-inner-pages">
        <div class="container d-flex align-items-center justify-content-between">
            ...
            <nav id="navbar" class="navbar">
                <ul>
                    <li><a class="scrollto efectoboton"
                            href="ver_asignaturas.php?idCarrera=<?php echo $idCarrera; ?>">Regresar</a></li>
                </ul>
    ...
    <div class="container">
        <br />
        <br />
        <h1 class="mb-4 text-center" style="font-size: 68px; font-weight:800;">Agregar asignatura</h1>
        <hr>
    ...
    ?>
                    ...
                    <textarea class="form-control mb-3" name="competencia" rows="4"></textarea>
