...
<body>
        ...
        <header id="header" class="fixed-top2 header-inner-pages">
            <div class="container d-flex align-items-center justify-content-between">
                ...
                <nav id="navbar" class="navbar">
                    <ul>
                        <li><a class="scrollto efectoboton" href="crear.php">Agregar subdirectivo</a></li>
    ...
    <br>
        <h1 class="mb-4 text-center" style="font-size: 68px; font-weight:800;">Subdirectivos</h1>
        <br>
        <br>
        <div class="card">
            <div class="card-body">
    ...
    ?>
        ...
        $query = "SELECT * FROM subdirectores ORDER BY apellidos";
        $respuesta = mysqli_query($conn, $query);

        while($registro = mysqli_fetch_array($respuesta)) {
            echo("<tr>");
            echo("<td>$registro[idSubdirector]</td>");
            ...
            echo("<td>
                <div class='btn-group'>
                    <a class='btn btn-primary btn-sm mr-1' href='editar.php?idSubdirector=$registro[idSubdirector]'>Editar</a>
                    |
                    <a class='btn btn-danger btn-sm mr-1' href='borrar.php?idSubdirector=$registro[idSubdirector]'>Eliminar</a>
                </div>
            </td>");
            echo("</tr>");
        }
