...
<body>
        ...
        <header id="header" class="fixed-top2 header-inner-pages">
            <div class="container d-flex align-items-center justify-content-between">
                ...
                <nav id="navbar" class="navbar">
                    <ul>
                        <li><a class="scrollto efectoboton" href="crear.php">Agregar empresa</a></li>
    ...
    <main class="container mt-4" style="max-width: 1600px;">
        <br>
        <h1 class="mb-4 text-center" style="font-size: 68px; font-weight:800;">Empresas Dual</h1>
        <br>
        <br>
        <div class="card">
            <div class="card-body">
                ...
                <div class="table-responsive text-center table-hover">
                    <table class="table table-responsive-sm text-center table-hover" id="tabla_id">
                        ...
                        <tbody>
                            <?php
                include("../../templates/conexion.php");
                $query = "SELECT * FROM empresas WHERE estatus_empresa='Activo' OR estatus_empresa='En proceso' ORDER BY idEmpresa DESC";
                ...
                while ($registro = mysqli_fetch_array($respuesta)) {
                    ...
                    echo("<td>
                        <div class='btn-group'>
                            <a class='btn btn-primary btn-sm mr-1' href='editar.php?idEmpresa=$registro[idEmpresa]'>Editar</a>
                            <a class='btn btn-secondary btn-sm mr-1' href='desvincular.php?idEmpresa=$registro[idEmpresa]'>Desactivar</a>
                            |
