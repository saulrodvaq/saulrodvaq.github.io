...
<body>
    ...
    <!-- Formulario para editar los datos del tutor -->
    <div class="container">
        <br />
        <br />
        ...
        <form action="actualizar.php" method="POST">
            <div class="row">
                <div class="col-md-6 offset-md-3">
                    <input type="hidden" class="form-control mb-3" name="idTutor"
                        value="<?php echo $tutor['idTutor']; ?>">
                    <label for="nombres">Nombre(s):</label>
                    <input type="text" class="form-control mb-3" name="nombres"
                        value="<?php echo $tutor['nombres']; ?>">
                    <label for="apellidos">Apellidos:</label>
                    <input type="text" class="form-control mb-3" name="apellidos"
                        value="<?php echo $tutor['apellidos']; ?>">
                    <label for="matricula">Matrícula:</label>
                    <input type="text" class="form-control mb-3" name="matricula"
                        value="<?php echo $tutor['matricula']; ?>">
                    <label for="usuario">Usuario:</label>
                    <input type="text" class="form-control mb-3" name="usuario"
                        value="<?php echo $tutor['usuario']; ?>">
                    <label for="password">Password:</label>
                    <input type="text" class="form-control mb-3" name="password"
                        value="<?php echo $tutor['password']; ?>">
                    <div class="d-flex justify-content-center">
                        <a href="tutores.php" class="btn btn-danger mx-1" boton class="boton boton1">Cancelar</a>
