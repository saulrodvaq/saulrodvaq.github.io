...
<body>
        ...
        <header id="header" class="fixed-top2 header-inner-pages">
            <div class="container d-flex align-items-center justify-content-between">
                ...
                <nav id="navbar" class="navbar">
                    <ul>
                        <li><a class="scrollto efectoboton" href="crear.php">Agregar tutor</a></li>
    ...
    <main class="container mt-4" style="max-width: 1600px;">
        <br>
        <h1 class="mb-4 text-center" style="font-size: 68px; font-weight:800;">Tutores Académicos</h1>
        <br>
        <br>
        <div class="card">
            <div class="card-body">
    ...
    ?>
        ...
        $query = "SELECT * FROM tutores ORDER BY apellidos";
        ...
        while($registro = mysqli_fetch_array($respuesta)) {
            ...
            echo("<td>
                <div class='btn-group'>
                    <a class='btn btn-primary btn-sm mr-1' href='editar.php?idTutor=$registro[idTutor]'>Editar</a>
                    <a class='btn btn-secondary btn-sm mr-1' href='asignacion.php?idTutor=$registro[idTutor]'>Asignación de alumnos</a>
                    |
                    <a class='btn btn-danger btn-sm mr-1' href='borrar.php?idTutor=$registro[idTutor]'>Eliminar</a>
                </div>
            </td>");
            echo("</tr>");
        }
