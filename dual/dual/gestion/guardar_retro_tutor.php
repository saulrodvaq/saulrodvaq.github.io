...
// Actualizar los campos 'retro_tutor' y 'estatus_tutor' en la base de datos para el ID correspondiente
$sql = "UPDATE reportes SET retro_tutor = '$retro', estatus_tutor = '$estatus' WHERE idReporte = '$id'";
