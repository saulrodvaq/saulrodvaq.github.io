        ...
        <div className="row align-items-center align-items-stretch">
          ...
          <div className="col bg-white p-5 col-lg-7 col-xl-6 rounded-end">
            ...
            <form onSubmit={handleSubmit} noValidate>
              ...
              <div className="my-3">
                <span>
                  No tienes una cuenta? <a href="register">Regístrate</a><br></br><br></br>
                </span>
                <span>
                  ¿Se te olvidó la contraseña?, dale al siguente link para recuperarla. <a href="recon">Recuperar contraseña</a>
                </span>
              </div>
            </form>
          </div>
